...
$trainingCertDir = '../trainingcertFiles/';
if (!is_dir($trainingCertDir)) {
    mkdir($trainingCertDir, 0777, true);
}
...
if (isset($_POST['upload'])) {
    if (!empty($_FILES['file']['name'][0])) {
        ...
        for ($i = 0; $i < count($files['name']); $i++) {
            ...
            $targetFilePath = $trainingCertDir . $fileName;
...
if (isset($_POST['delete']) && isset($_POST['file_name'])) {
    $fileToDelete = $trainingCertDir . $_POST['file_name'];
...
if (isset($_POST['rename']) && isset($_POST['old_name']) && isset($_POST['new_name'])) {
    $oldPath = $trainingCertDir . $_POST['old_name'];
    $newPath = $trainingCertDir . $_POST['new_name'];
...
$filesAndFolders = array_diff(scandir($trainingCertDir), array('.', '..'));
...
<div class="container mt-4">
    <div class="container-box">
        ...
        <ul class="nav nav-pills nav-fill bg-success p-2 rounded">
            ...
            <li class="nav-item">
                <a class="nav-link active btn btn-secondary" href="trainingcert.php">Training Certificates</a>
            </li>
            <li class="nav-item">
