...
if (isset($_POST['rename']) && isset($_POST['old_name']) && isset($_POST['new_name'])) {
    $oldPath = $driversDir . $_POST['old_name'];
    $newPath = $driversDir . $_POST['new_name'];
...
$filesAndFolders = array_diff(scandir($driversDir), array('.', '..'));
...
<div class="container mt-4">
    <div class="container-box">
        ...
        <ul class="nav nav-pills nav-fill bg-success p-2 rounded">
            ...
            <li class="nav-item">
            <a class="nav-link  activebtn btn-secondary text-white fw-bold shadow-lg" href="drivers.php">Drivers</a>
            </li>
        </ul>
