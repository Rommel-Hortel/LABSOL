...
if (isset($_POST['rename'])) {
    $oldName = $OpSoftWareDir . $_POST['old_name'];
    $newName = $OpSoftWareDir . $_POST['new_name'];
...
// List uploaded files
$files = array_diff(scandir($OpSoftWareDir), array('.', '..'));
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            <?php foreach ($filteredFiles as $file): ?>
                <tr>
                    <td><a href="<?php echo $OpSoftWareDir . $file; ?>" target="_blank" class="text-primary"> <?php echo $file; ?> </a></td>
                    <td>
                        <a href="<?php echo $OpSoftWareDir . $file; ?>" target="_blank" class="btn btn-success btn-sm">View</a>
